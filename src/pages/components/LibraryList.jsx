                        ...
                        <div className="w-4/12 overflow-hidden bg-white rounded-2xl lg:w-3/12">
                            <div className="bg-white">
                                ...
                                <div className="max-w-xs m-auto lg:max-w-mi">
                                    ...
                                    <span className="font-semibold text-2xl text-gray-700 leading-none tracking-tighter lg:text-lg">Como aumentar sua Geração de Leads feat. Traktor</span>
                                </div>
                                ...
                                <div className="flex flex-col py-5 px-4 lg:py-4 lg:px-3">
                                    <span className="font-semibold lg:text-sm">Descrição</span>
